...
function add_new_music($refers_to, $creation_user, $viewable_status, $license_name, $license_url, $one_line_summary, $description, $language, $filename, $mime_type, $temp_filename) {
  require_once("../modules/mod-content/music.lib");
  return content_add_new_music($refers_to, $creation_user, $viewable_status, $license_name, $license_url, $one_line_summary, $description, $language, $filename, $mime_type, $temp_filename);
}
