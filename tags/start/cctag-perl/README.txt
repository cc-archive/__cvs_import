NAME
    cctag.pl - Tags mp3 files with license claim URL and generates claim
    RDF.
...
SYNOPSIS
    ...
    cctag.pl tags files (currently only mp3s) with license claim metadata
    and prints backing license claim RDF to STDOUT.
...
SEE ALSO
    http://creativecommons.org/learn/tech/nonweb
            Guidelines for embedding license claims in files.

    http://creativecommons.org/learn/tech/mp3
            Instructions for embedding license claims in MP3 files.

    http://sourceforge.net/projects/cctools/
